...
## Project Structure
    ...
    ├── testapiautoteammemb_75441  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_75441`
...
2. Clone this repo and `cd testapiautoteammemb_75441`
